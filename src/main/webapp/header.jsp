...
<div id="wrapper">
    ...
    >
        ...
        <c:if test="${sessionScope.SPRING_SECURITY_CONTEXT != null}">
            <p class="nav-link" style="text-align: center; color: #f0f0f0; margin-top: 20px; margin-bottom: 5px;">Panel
                użytkownika:</p>
            ...
            <sec:authorize access="hasRole('ROLE_ADMIN')">
                <p class="nav-link" style="text-align: center; color: #f0f0f0; margin-top: 20px; margin-bottom: 5px;">
